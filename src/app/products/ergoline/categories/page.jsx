...
function ProductsPageContent() {
  ...
  const categories = [
    ...
    { key: "Bicycle Ergometers", label: "Bicycle Ergometers" },
    { key: "Special Ergometers", label: "Special Ergometers" },
    { key: "Reclining Ergometers", label: "Reclining Ergometers" },
    { key: "Training Ergometers", label: "Training Ergometers" },
    { key: "Treadmill", label: "Treadmill" },
    { key: "Equipment Carts", label: "Equipment Carts" },
  ];
    ...
    rounded-lg border-2 border-gray-100`}
        ...
        <section className="flex-1 lg:ml-6">
          <h1 className="text-4xl font-bold mb-8">
            From the House of{" "}
            <span className="text-green-700 font-black text-5xl">ERGOLINE</span>
          </h1>
